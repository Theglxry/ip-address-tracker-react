...
function Stats({ ipAddress, location, timeZone, isp }) {
  ...
  return (
    <div className="shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] top-[16rem]
     md:mt-4 w-4/5 rounded-lg absolute  md:top-60 left-[5rem] md:left-40
     bg-white z-50 flex flex-col sm:flex-row container gap-4 md:gap-10 p-4 md:p-8 ">
