...
function Stats({ ipAddress, location, timeZone, isp }) {
  ...
  return (
    <div className="w-4/5 rounded-lg absolute top-52 md:top-60 left-10 md:left-40 bg-white z-50 flex flex-col sm:flex-row container gap-4 md:gap-10 p-4 md:p-8 ">
